...
import { loadDotEnv, discoverWorkflow, loadWorkflow, buildConfig, validateForDispatch, warnForDispatch } from "../config/workflow.js";
...
async function main() {
  ...
  if (args.command === "validate") {
    ...
    for (const w of warnForDispatch(config)) logger.warn(w);
